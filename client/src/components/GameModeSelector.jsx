...
function GameModeSelector({ gameMode, setGameMode, paragraphWrapper }) {
  ...
  const gameModeDescriptions = {
    ...
    Challenge:
      "First guess is randomly generated, subsequent guesses must use all previously revealed hints",
  }
