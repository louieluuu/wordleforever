...
export default function DialogIntro({ setIsDialogOpen }) {
    ...
    <Dialog
      ...
      <Dialog.Panel>
        <div className="dialog__right" ref={exitButton}>
          <IoCloseSharp className="dialog__btn--close" onClick={() => setIsDialogOpen(false)} />
        </div>

        <Dialog.Title style={{ fontFamily: "Calistoga", marginTop: "0.5rem", marginBottom: "0" }}>
          How To Play
        </Dialog.Title>
        <Dialog.Description
          style={{
        ...
        <ul style={{ fontSize: "0.90rem", paddingBottom: 0, paddingLeft: "1rem" }}>
          <li style={{ marginBottom: "0.1rem" }}>Each guess must be a valid 5-letter word.</li>
          <li>
            The color of the tiles will change to show how close<br></br>your guess was to the word.
          </li>
        </ul>
        ...
        <p>
          ...
          <a href="https://github.com/louieluuu/wordle-forever">Github</a>.&nbsp;Your feedback is
