...
function InfoDialog({ show, handleClose }) {
  const handleInfoDialogClose = () => {
    handleClose()
  }

  return (
    <div className={show ? "info-dialog display" : "info-dialog hide"}>
      <div className="info-content">
        <div className="info-content__close" onClick={handleInfoDialogClose}>
          <IoCloseSharp />
        </div>
